...
export default async function syncLocalStorageChangeHistoryAndDatabaseWhere( where ) {
	...
	// Q: why doesn't this use postChangeToLocalStorage?
	// A: because we're batching the work and only getting/setting the localstorage item once
	// ...so TODO maybe postChange should be postChanges and it should take an array?
